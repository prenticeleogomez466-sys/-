...
const deep = {
  ...
  "浦和红钻 vs 冈山绿雉": { tier: 3, ctx: "6名次回合·1-1→次回合定",
    ...
    v: "🔴弃(胶着无edge)" },
  "鹿岛鹿角 vs 神户胜利船": { tier: 2, ctx: "冠军决赛次回合·首回合神户5-0→累计0-5｜✅阵容已出",
    sh: "✅阵容已出:神户摆全主力(大迫勇也+武藤嘉纪+酒井高徳+权田 全首发,4-3-3)→已锁夺冠仍派最强=有意拿下,'死签轮换躺赢'被阵容推翻;鹿岛(4-4-2)亦全主力。客胜(神户)比模型0-1更可信,但单场变数+鹿岛主场荣誉战留平/小负空间",
    v: "🟡可参考偏客(阵容证神户全主力·非躺赢)" },
...
const summary = [
  ...
  ["", "", ""],
  ["👥 阵容", "仅鹿岛-神户已出", "ESPN实时:鹿岛4-4-2/神户4-3-3,神户摆全主力(大迫+武藤+酒井+权田)=非躺赢轮换→纠正我先前推断。其余8场阵容未出(赛前约1h公布),赛前1h自动重抓重分析再推你一份"],
  ["", "", ""],
  ["⚠️诚实", "全部", "无兜底·缺失标缺(开赛时刻多源冲突/8场阵容未出/近况伤停免费源空缺均未臆造);精确比分上限~13%、半全场~30%,深度改善解读不保证命中;免费数据打不过收盘线,下注由你定"],
];
...
${cardHtml}
<div class="note">👥 阵容:仅鹿岛-神户已出(ESPN实时)——神户摆全主力(大迫勇也+武藤嘉纪+酒井高徳+权田),已锁夺冠仍派最强→推翻"死签轮换躺赢"推断,客胜更可信;其余8场阵容未出(赛前约1h公布),赛前1h自动重抓重分析。<br>⚠️ 比分/半全场=据真实情景对模型泊松人工校读;缺失(开赛时刻多源冲突/8场阵容未出/近况伤停)=标缺不臆造。精确比分上限~13%、半全场~30%,不保证命中。免费数据打不过收盘线,下注由你定。</div>
</body></html>`;
