# 足球大模型结构审计 2026-05-20

状态：失败
生成时间：2026-05-21T11:29:02.238Z
...
| 赔率层 | 市场快照 | 通过 | 20 个快照 |
| 赔率层 | 实时赔率覆盖 | 警告 | 0/26 |
| 闸门层 | 实时数据源闸门 | 失败 | 全量赔率硬门槛失败：真实赔率覆盖不完整：20/26；玩法赔率不完整：12/26，竞彩足球需欧洲赔率、亚洲盘口、让球胜平负；14场需欧洲赔率、亚洲盘口；实时赔率不完整：20/26 |
| 闸门层 | 闸门新鲜度 | 警告 | 1331 分钟 |
| 输出层 | 每日推荐 XLSX | 警告 | 缺失 |
| 输出层 | 复盘总表 XLSX | 通过 | 65272 bytes |
