# 足球大模型结构审计 2026-05-24

状态：失败
生成时间：2026-05-24T03:08:58.333Z
...
| 赔率层 | 市场快照 | 通过 | 28 个快照 |
| 赔率层 | 实时赔率覆盖 | 通过 | 37/42 |
| 闸门层 | 实时数据源闸门 | 失败 | 全量赔率硬门槛失败：真实赔率覆盖不完整：37/42；玩法赔率不完整：0/42，竞彩足球需欧洲赔率、亚洲盘口、让球胜平负；14场需欧洲赔率、亚洲盘口；实时赔率不完整：37/42 |
| 闸门层 | 闸门新鲜度 | 通过 | 0 分钟 |
| 输出层 | 每日推荐 XLSX | 警告 | 缺失 |
| 输出层 | 复盘总表 XLSX | 通过 | 213444 bytes |
