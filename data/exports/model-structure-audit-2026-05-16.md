# 足球大模型结构审计 2026-05-16

状态：失败
生成时间：2026-05-16T04:27:05.365Z
...
| 赔率层 | 市场快照 | 通过 | 44 个快照 |
| 赔率层 | 实时赔率覆盖 | 通过 | 44/44 |
| 闸门层 | 实时数据源闸门 | 失败 | 全量赔率硬门槛失败：玩法赔率不完整：14/44，竞彩足球需欧洲赔率、亚洲盘口、让球胜平负；14场需欧洲赔率、亚洲盘口 |
| 闸门层 | 闸门新鲜度 | 通过 | 2 分钟 |
| 输出层 | 每日推荐 XLSX | 警告 | 缺失 |
| 输出层 | 复盘总表 XLSX | 通过 | 40742 bytes |
