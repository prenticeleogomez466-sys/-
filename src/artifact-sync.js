...
function artifactPaths(date) {
  return [
    ...
    join(exportDir, `source-vetting-${date}.json`),
    join(exportDir, `source-vetting-${date}.md`),
    join(exportDir, `recap-automation-health-${date}.json`),
    join(exportDir, `recap-automation-health-${date}.md`),
