...
const DEFAULT_ENV = {
  ...
  // 2026-05-28: sporttery WAF 多次返回 HTTP 567,把 China 源重试提到 5 次,
  // 配合 china-web-sources.js 里的 UA 池 + 指数退避 + 抖动,能显著降低被一次性挑战拦死的概率。
  CHINA_SOURCE_RETRY_ATTEMPTS: "5",
  CHINA_SOURCE_TIMEOUT_MS: "12000",
  ...
  // 2026-05-28: 默认启用 500.com 胜负彩亚盘 + 欧赔。
  // 当新浪澳盘对冷门联赛(如 2026-05-28 尼斯-圣埃蒂安)拿不到亚洲盘口时,
  // 这条作为关键兜底,可以把 13/14 complete 拉满到 14/14。
  FIVEHUNDRED_SFC_ASIAN_ENABLED: "1",
