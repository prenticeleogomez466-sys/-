...
const ISO_CN = {
  ...
  EG: "埃及", PE: "秘鲁", SQ: "苏格兰", HU: "匈牙利", PY: "巴拉圭", CR: "哥斯达黎加", TN: "突尼斯",
  // 2026-06-13 补漏:eloratings 用 SQ(非SCO)表苏格兰;HT/CD/CW 为标准ISO,原表缺 →
  // 今天 海地vs苏格兰、葡萄牙vs刚果(金)、德国vs库拉索 三场 WC 实盘曾因缺 Elo 退化,现真补。
  HT: "海地", CD: "刚果(金)", CW: "库拉索",
